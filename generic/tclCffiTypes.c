...
# define DCSIG(char_) DC_SIGCHAR_ ## char_
#else
# define DCSIG(char_) 0
#endif
...
CffiResult
CffiCheckVarargType(Tcl_Interp *ip,
                          ...
                          Tcl_Obj *typeObj)
{
     ...
     * TODO - what about pointers, strings, binaries etc. ?
     */
        ...
        case CFFI_K_TYPE_WINSTRING:
            if (memlifoP == NULL) {
                ...
                if (typeAttrsP->flags & CFFI_F_ATTR_MULTISZ) {
                    ...
                    wsP = Tclh_ObjToWinCharsLifo(ipCtxP->tclhCtxP,
                                                 &ipCtxP->memlifo,
                                                 valueObj,
                                                 &num);
                    CFFI_ASSERT(wsP);
